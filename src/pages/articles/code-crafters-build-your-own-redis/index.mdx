...
For example, the first step asks you to set up a TCP server. You then learn how to encode & decode messages using the [Redis serialization protocol (RESP) specification](https://redis.io/topics/protocol#resp-simple-strings), and you keep building up features from there.
