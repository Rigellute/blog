...
import part1 from './part-1.png'
import part2 from './part-2.png'
import part3 from './part-3.png'
import part4 from './part-4.png'
...
- Enter your server URL and add `/{proxy}` at the end of the URL. Should look like this:
  <Image src={part1} alt="Create API" />
